module github.com/airenas/roxy

go 1.18

require (
	github.com/airenas/async-api v0.4.53
	github.com/airenas/big-tts v0.0.0-20220607061310-af69aa7a3fc9
...
require (
	...
	github.com/vgarvardt/gue/v5 v5.0.0-20221117214937-23d992003b8e // indirect
